...
#include "inc/JsonBox/Grammar.h"
#include "inc/JsonBox/Convert.h"
...
namespace JsonBox {
	...
	double Value::getNumber() const
	{
		...
		{
			return (type == Type::INTEGER ? *valuePointer.intValue : *valuePointer.doubleValue);
		} else
		{
			return EMPTY_INT;
		}
